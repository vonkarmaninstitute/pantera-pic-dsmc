...
CMPF  = mpifort -c -g
LNK   = mpifort 
# OPTF = -O0 -Wall -Wextra -Warray-temporaries -ggdb3 -pg -pedantic -fimplicit-none -fcheck=all -fbacktrace -ffpe-trap=invalid,zero,overflow,underflow -mcmodel=medium # Debug options  
