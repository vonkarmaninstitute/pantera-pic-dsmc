MODULE postprocess
   ...
   SUBROUTINE BOUNDARY_GATHER
      ...
      IF (PROC_ID .EQ. 0) THEN
         ...
         CALL MPI_REDUCE(MPI_IN_PLACE,  TIMESTEP_PXEM,  NBOUNDCELLS*N_SPECIES,MPI_DOUBLE_PRECISION,MPI_SUM,0,MPI_COMM_WORLD,ierr)
         CALL MPI_REDUCE(MPI_IN_PLACE,  TIMESTEP_PYEM,  NBOUNDCELLS*N_SPECIES,MPI_DOUBLE_PRECISION,MPI_SUM,0,MPI_COMM_WORLD,ierr)
         CALL MPI_REDUCE(MPI_IN_PLACE,  TIMESTEP_PZEM,  NBOUNDCELLS*N_SPECIES,MPI_DOUBLE_PRECISION,MPI_SUM,0,MPI_COMM_WORLD,ierr)
      ...
      ELSE
         ...
         CALL MPI_REDUCE(TIMESTEP_PXEM, TIMESTEP_PXEM,  NBOUNDCELLS*N_SPECIES,MPI_DOUBLE_PRECISION,MPI_SUM,0,MPI_COMM_WORLD,ierr)
         CALL MPI_REDUCE(TIMESTEP_PYEM, TIMESTEP_PYEM,  NBOUNDCELLS*N_SPECIES,MPI_DOUBLE_PRECISION,MPI_SUM,0,MPI_COMM_WORLD,ierr)
         CALL MPI_REDUCE(TIMESTEP_PZEM, TIMESTEP_PZEM,  NBOUNDCELLS*N_SPECIES,MPI_DOUBLE_PRECISION,MPI_SUM,0,MPI_COMM_WORLD,ierr)
