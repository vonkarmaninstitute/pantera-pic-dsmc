...
USE mpi_common
   ...
   TYPE, ABSTRACT :: VELOCITY_DISTRIBUTION_STRUCTURE
      ...
      PROCEDURE(FLX_TYPE), DEFERRED :: FLX
      PROCEDURE(FLUXSOURCE_TYPE), DEFERRED :: FLUXSOURCE
   ...
   ABSTRACT INTERFACE
      ...
      FUNCTION FLX_TYPE(THIS, SN, TINF, M) RESULT(OUT)
         IMPORT :: VELOCITY_DISTRIBUTION_STRUCTURE
         CLASS(VELOCITY_DISTRIBUTION_STRUCTURE), INTENT(IN) :: THIS
      ...
      END FUNCTION FLX_TYPE



      FUNCTION FLUXSOURCE_TYPE(THIS, S_NORM, U_NORM, TTRA, M) RESULT(OUT)
         IMPORT :: VELOCITY_DISTRIBUTION_STRUCTURE
         CLASS(VELOCITY_DISTRIBUTION_STRUCTURE), INTENT(IN) :: THIS
