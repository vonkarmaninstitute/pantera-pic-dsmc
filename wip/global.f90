...
CONTAINS  ! @@@@@@@@@@@@@@@@@@@@@ SUBROUTINES @@@@@@@@@@@@@@@@@@@@@@@@
   ...
   SUBROUTINE NEWTYPE
      ...
      oldtypes(1:11) = MPI_DOUBLE_PRECISION  
      oldtypes(12:13) = MPI_INTEGER
      oldtypes(14) = MPI_INTEGER8
      oldtypes(15) = MPI_LOGICAL
          
      offsets(1) = 0  
      DO ii = 2, 12
         offsets(ii) = offsets(ii - 1) + extent_dpr * blocklengths(ii - 1)
      END DO
      offsets(13) = offsets(12) + extent_int * blocklengths(12)
      offsets(14) = offsets(13) + extent_int * blocklengths(13)
      offsets(15) = offsets(14) + extent_int8 * blocklengths(14)
